...
ALTER TABLE ratings ADD COLUMN IF NOT EXISTS ip_address TEXT;
...
ALTER TABLE ratings ADD CONSTRAINT ratings_unique_per_movie UNIQUE(movie_id, device_id, ip_address);
...
ALTER TABLE reactions ADD CONSTRAINT reactions_unique_per_movie UNIQUE(movie_id, device_id, ip_address);